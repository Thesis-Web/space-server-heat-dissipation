...
exports.aggregateScenario = aggregateScenario;
...
function aggregateScenario(input) {
    ...
    const w_dot_device_at_state_w = (0, loads_1.devicePowerAtState)(input.device_powers, input.target_load_state);
    ...
    const w_dot_compute_module_w = w_dot_devices_total_w +
    ...
    const q_dot_internal_w = w_dot_compute_module_w +
    ...
    const q_dot_total_reject_w = q_dot_internal_w +
...
//# sourceMappingURL=scenario-aggregation.js.map