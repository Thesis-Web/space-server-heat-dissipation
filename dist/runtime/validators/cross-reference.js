...
exports.validateZoneTopologyRefs = validateZoneTopologyRefs;
exports.validateWorkingFluidRefs = validateWorkingFluidRefs;
exports.validatePickupGeometryRefs = validatePickupGeometryRefs;
/**
 ...
 */
function validateZoneTopologyRefs(zones) {
    const violations = [];
 ...
 */
function validateWorkingFluidRefs(zones, availableFluidIds) {
    const violations = [];
 ...
 */
function validatePickupGeometryRefs(zones, availableGeomIds) {
    const violations = [];
