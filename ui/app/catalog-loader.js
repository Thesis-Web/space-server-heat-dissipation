...
// ── Extension 3B catalog helpers — 3B-spec §10, §16 ──────────────────────────

/**
 * Lookup a preset entry by preset_id in a 3B preset catalog.
 * 3B-spec §10: all preset catalogs use preset_id as the key field.
 * Returns the preset entry or null.
 */
...
/**
 * Build extension_3b_catalog_versions sub-object for packet/run-packet metadata.
 * 3B-spec §10.5.
 */
